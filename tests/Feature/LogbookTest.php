...
class LogbookTest extends TestCase
{
    ...
    public function test_technician_starts_and_finishes_without_editing_timestamps(): void
    {
        ...
        $this->withSession(['_token' => $token])->actingAs($user)->post(route('operator.start', $asset), ['_token' => $token, 'work_type' => 'inspection', 'started_at' => '2000-01-01 00:00'])->assertRedirect();
